...
export default function KnowledgeBasePage() {
  ...
  const [newProd, setNewProd] = useState({ name: "", description: "", category: "core", classification: "", scope: "global", features: [] as string[], marketNames: [] as string[], personaNames: [] as string[], competitorNames: [] as string[], bundleParentId: null as string | null });
